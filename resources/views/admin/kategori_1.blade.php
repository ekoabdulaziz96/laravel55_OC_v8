  ...
  <div class="box box-info">
    <div class="box-title">
      ...
      <div class="panel-heading">
         <i style="font-size: 20px">List Kategori</i>
                         ...
                         {{ csrf_field() }}
                          ...
                          @foreach ($post as $value)
                            <tr class="post{{$value->id}}">
                              ...
                              @endphp
                               <td align="center">
                                <a onclick="showForm($value->id)" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-eye-open"></i></a>
                                <a onclick="editForm($value->id)" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-edit"></i></a> 
                                <a onclick="deleteForm($value->id)" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i></a>
    ...
    <script type="text/javascript">
      ...
      function addForm() {
        ...
        $('.modal-title').text('Add Kategori');
            ...
            $('#modal-footer').addClass('modal-header-add'); 
            $('#modal-header').removeClass('modal-header-edit');
            $('#modal-footer').removeClass('modal-header-edit');
            $('#modal-header').removeClass('modal-header-delete');
            $('#modal-footer').removeClass('modal-header-delete'); 
            $('#modal-header').removeClass('modal-header-show');
            $('#modal-footer').removeClass('modal-header-show');
      ...
      function editForm(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#modal-footer').removeClass('modal-header-add'); 
            $('#modal-header').addClass('modal-header-edit');
            $('#modal-footer').addClass('modal-header-edit');
            $('#modal-header').removeClass('modal-header-delete');
            $('#modal-footer').removeClass('modal-header-delete'); 
            $('#modal-header').removeClass('modal-header-show');
            $('#modal-footer').removeClass('modal-header-show');
      ...
      function deleteForm(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#modal-footer').addClass('modal-header-delete'); 
            $('#modal-header').removeClass('modal-header-show');
            $('#modal-footer').removeClass('modal-header-show');
       ...
       function showForm(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#modal-footer').addClass('modal-header-show');
