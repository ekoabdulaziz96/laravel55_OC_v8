  ...
  <div class="box box-info">
    <div class="box-title">
      ...
      <div class="panel-heading">
         <i style="font-size: 20px">List User</i>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group date ">
                  ...
                  <input type="text" class="form-control pull-right" id="tgl_lahir-edit" name="tgl_lahir-edit">
                </div>
              </div>
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div class="input-group">
                  ...
                  <input id="no_hp_edit" name="no_hp-edit" type="text" class="form-control" data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask >
