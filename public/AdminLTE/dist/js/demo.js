...
// +'         <li class="control-sidebar-subheading">'
// +'          <a class="dropdown-item" href="{{ route(\'logout\') }}"  onclick="">'
// +'           <span style="color:white">Ubah Email</span> '
// +'          <i class="menu-icon fa  fa-user-secret text-green pull-right"  aria-hidden="true"></i>'
// +'        </a>'
// +'      </li>'
...
// +'         <li>'
// +'          <a class="dropdown-item" href="{{ route(\'logout\') }}"  onclick="">'
// +'           <span style="color:white">Ubah Password</span> '
// +'          <i class="menu-icon fa  fa-unlock bg-green pull-right"  aria-hidden="true"></i>'
// +'        </a>'
// +'      </li>'
